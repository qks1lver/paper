...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', dest='data_dir', default=None, help='Directory of sequence files')
    parser.add_argument('-o', dest='out_dir', default=None, help='Directory for results')
    parser.add_argument('-r', dest='ref', default=None, help='Reference_genome.fa')
